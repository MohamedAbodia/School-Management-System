...
<button class="btn btn-lg btn-success" type="button">Supervisor Dashboard</button>
</div><br>
                <!-- TABLE CONSTRUCTION--> 
...
<?php include 'inc/header.inc.php'; ?>
        ...
        <body> 
            <section> 
                ...
                <h1></h1>
                <div class='d-grid gap-2'>
                    <button class='btn btn-lg btn-success' type='button'>Courses List</button></div>
                <br>
		...
		<?php include 'inc/header.inc.php'; ?>
                        <h1></h1>
<div class="d-grid gap-2">
<button class="btn btn-lg btn-success" type="button">Edit Student</button>
</div><br>
            <div class="container">
    ...
    function updateStudent(){
        ...
        echo "<h1></h1><div class='d-grid gap-2'>
<button class='btn btn-lg btn-success' type='button'>Update Member</button>
</div><br>";
    }
function AddStudent(){
        ?>
				<?php include 'inc/header.inc.php'; ?>
<h1></h1><div class='d-grid gap-2'>
<button class='btn btn-lg btn-success' type='button'>Add New Member</button>
</div><br>
			<div class="container">
				<form class="form-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group form-group-lg">
						<label class="col-sm-2 control-label">Student Id</label>
						<div class="col-sm-10 col-md-6">
							<input type="text" name="newid" class="password form-control" required="required" autocomplete="new-password" placeholder="Enter Student ID" />
						</div>
					</div>
					<!-- End Password Field -->
					<!-- Start Email Field -->
					...
					<div class="form-group form-group-lg">
						<label class="col-sm-2 control-label">Student Address</label>
						<div class="col-sm-10 col-md-6">
							<input type="text" name="address" class="form-control" required="required" placeholder="Full Address Appear In Your Profile Page" />
						</div>
					</div>
...
<h1></h1><div class='d-grid gap-2'>
<button class='btn btn-lg btn-success' type='button'>Add notification</button>
            <div class="container">
...
function InsertCourse() {
    ...
    <?php require_once '../views/inc/header.inc.php' ?>
<h1></h1><div class='d-grid gap-2'>
<button class='btn btn-lg btn-success' type='button'>Add Course</button>
            <div class="container">
