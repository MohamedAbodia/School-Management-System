...
<br>
    <div class='d-grid gap-2'>
        <button class="btn btn-lg btn-primary" type="button"><?php echo "Welcome ,"; echo $StdObj->studentName;?></button>
                </div><br>
 <style>
    .tabcontent{
...
//            echo"<table class='table table-hover'><tr><th>studentId</th><tr><td>".$StdObj->studentId."</td>";
//             echo"<table class='table table-hover'><th>studentName</th><tr><td>".$StdObj->studentName."</td>";
//              echo"<table class='table table-hover'><th>studentEmail</th><tr><td>".$StdObj->studentEmail."</td></tr>";
//              echo"<table class='table table-hover'><th>studentRes</th><tr><td>".$StdObj->stdRes."</td></tr>";
//            echo"</td><tr>";
//            echo"</table>";
...
//                        echo"<table class='table table-hover'><tr><th>ExamID</th><tr><td>".$StdObj->ExamObjArray[$i]->ExamID."</td>";
//                         echo"<table class='table table-hover'><tr><th>ExamName</th><tr><td>".$StdObj->ExamObjArray[$i]->ExamName."</td>";
//                        echo"<table class='table table-hover'><tr><th>ExamDate</th><tr><td>".$StdObj->ExamObjArray[$i]->ExamDate."</td>";
//                         echo"<table class='table table-hover'><tr><th>ExamRes</th><tr><td>".$StdObj->ExamObjArray[$i]->ExamRes."</td>";
//            
//            echo"</td><tr>";
//            echo"</table>";
...
//               
//                        echo"<table class='table table-hover'><tr><th>Coursecode</th><tr><td>".$StdObj->courseObjArray[$i]->courseCode."</td>";
//                        echo"<table class='table table-hover'><tr><th>CourseName</th><tr><td>".$StdObj->courseObjArray[$i]->courseName."</td>";
//                        echo"<table class='table table-hover'><tr><th>CourseDesc</th><tr><td>".$StdObj->courseObjArray[$i]->CourseDesc."</td>";
//                        echo"<table class='table table-hover'><tr><th>NumTeachers</th><tr><td>".$StdObj->courseObjArray[$i]->NumTeachers."</td>";
//                        echo"<table class='table table-hover'><tr><th>CourseMatrial</th><tr><td>".$StdObj->courseObjArray[$i]->CourseMatrial."</td>";
//                        
//                        
//                        
//                        
...
//               
//                        echo"<table class='table table-hover'><tr><th>day</th><tr><td>".$StdObj->scheduleObjArray[$i]->day."</td>";
//                        echo"<table class='table table-hover'><tr><th>TimeSlot</th><tr><td>".$StdObj->scheduleObjArray[$i]->TimeSlot."</td>";
//                        echo"<table class='table table-hover'><tr><th>roomID</th><tr><td>".$StdObj->scheduleObjArray[$i]->roomID."</td>";
//                        echo"<table class='table table-hover'><tr><th>courseID</th><tr><td>".$StdObj->scheduleObjArray[$i]->courseID."</td>";
//                        echo"<table class='table table-hover'><tr><th>groupType</th><tr><td>".$StdObj->scheduleObjArray[$i]->groupType."</td>";
//                        echo"<table class='table table-hover'><tr><th>groupNo</th><tr><td>".$StdObj->scheduleObjArray[$i]->groupNo."</td>";
//                        
//                        
//                        
//                        
